...
-- if EA_Items[EA_CLASS_MAGE] == nil then EA_Items[EA_CLASS_MAGE] = {} end;
   ...
   -- Fingers of Frost
		...
		if EA_Items[EA_CLASS_MAGE][44543] == nil then EA_Items[EA_CLASS_MAGE][44543] = true end;
		if EA_Items[EA_CLASS_MAGE][44545] == nil then EA_Items[EA_CLASS_MAGE][44545] = true end;
...
-- if EA_Items[EA_CLASS_PALADIN] == nil then EA_Items[EA_CLASS_PALADIN] = {} end;
	...
	-- Just used for testing  (DO NOT ENABLE THESE UNLESS YOU KNOW WHAT YOU ARE DOING).
		...
		-- Blessing of Might
		-- if EA_Items[EA_CLASS_PALADIN][48932] == nil then EA_Items[EA_CLASS_PALADIN][48932] = true end;
	...
	-- Light's Grace
		if EA_Items[EA_CLASS_PALADIN][31834] == nil then EA_Items[EA_CLASS_PALADIN][31834] = true end;
...
-- if EA_Items[EA_CLASS_WARLOCK] == nil then EA_Items[EA_CLASS_WARLOCK] = {} end;
    ...
    -- Pyroclasm
		if EA_Items[EA_CLASS_WARLOCK][18093] == nil then EA_Items[EA_CLASS_WARLOCK][18093] = true end;
		if EA_Items[EA_CLASS_WARLOCK][63243] == nil then EA_Items[EA_CLASS_WARLOCK][63243] = true end;
		if EA_Items[EA_CLASS_WARLOCK][63244] == nil then EA_Items[EA_CLASS_WARLOCK][63244] = true end;
